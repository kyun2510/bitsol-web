...
noticeController.getPostList = async (req, res) => {
    try {
        ...
        const postsData = await noticeModel.getPosts(page, pagerow);
...
noticeController.getPost = async (req, res) => {
    try {
        ...
        const post = await noticeModel.getPostById(not_id);
...
noticeController.submitPost = async (req, res) => {
    try {
        ...
        const post = await noticeModel.addPost(title, subtitle, content);
...
noticeController.editPost = async (req, res) => {
    try {
        ...
        const updated = await noticeModel.updatePost(updateData);
