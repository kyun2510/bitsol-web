...
router.put('/inquiry/del',controller.delInq)
router.put('/inquiry/status', controller.updateInquiryStatus)

// 미답변 건수 조회 (사이드바 배지용)
router.get('/inquiry/pending/count', controller.getPendingInquiriesCount)

// 문의 전체 목록 조회
router.get('/inquiry/all', controller.getAllInquiries)
